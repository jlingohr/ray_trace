...
impl Scene {
    // pub fn random_scene(rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
    ...
    // pub fn random_checkered_scene(rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
    //     let mut world = HittableList::new();
    ...
    // pub fn two_spheres(_rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
    //     let mut world = HittableList::new();
    //     let checkered = Checkered::new(
    //         SolidColor::new(0.2, 0.3, 0.1),
    //         SolidColor::new(0.9, 0.9, 0.9),
    ...
    // pub fn two_perlin_spheres(_rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
    //     let mut world = HittableList::new();
    ...
    pub fn cornell_box(_rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
        let mut world = HittableList::new();
    ...
    // pub fn cornell_smoke(_rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
    //     let mut world = HittableList::new();
    ...
    // pub fn final_scene(rng: &mut ThreadRng, aspect_ratio: f64) -> Scene {
